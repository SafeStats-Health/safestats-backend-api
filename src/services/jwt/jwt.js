...
module.exports.createToken = async function (user) {
  ...
  const payload = {
    user: {
      ...
      healthPlanInstitution: healthPlan ? healthPlan.institution : null,
      healthPlanType: healthPlan ? healthPlan.type : null,
      healthPlanAccomodation: healthPlan ? healthPlan.accomodation : null,
    },
    iss: issuer,
    iat: moment().unix(),
    exp: exp,
